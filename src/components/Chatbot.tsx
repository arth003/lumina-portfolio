      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-4 right-4 z-50 w-[300px] sm:w-[350px] max-w-[calc(100vw-2rem)] h-[380px] sm:h-[480px] max-h-[calc(100vh-6rem)] rounded-2xl overflow-hidden flex flex-col"
            style={{
