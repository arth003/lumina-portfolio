      ...
      <Section>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          <div className="space-y-5 text-muted-foreground leading-relaxed">
            <p>
              I'm a graduate student in Computer Science with a deep passion for building intelligent, scalable software systems. My journey in tech started with curiosity about how things work, and it has grown into a commitment to creating solutions that matter.
            </p>
            <p>
              My academic focus spans artificial intelligence, machine learning, and full-stack development. I enjoy the challenge of bridging cutting-edge research with practical, production-ready applications.
            </p>
            <p>
              When I'm not coding, you'll find me exploring new frameworks, contributing to open source, or reading about the latest breakthroughs in AI. I believe in continuous learning and the power of technology to transform lives.
            </p>
          </div>
