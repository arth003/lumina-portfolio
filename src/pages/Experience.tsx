...
const education = [
  {
    ...
    duration: "2023 – 2025",
    details: [
      "Focus: Artificial Intelligence & Systems",
      "Relevant Coursework: Machine Learning, Distributed Systems, Advanced Algorithms, NLP",
      "GPA: 3.9/4.0",
    ],
  },
  {
    ...
    details: [
      ...
      "Relevant Coursework: Data Structures, Operating Systems, Databases, Computer Networks",
      "GPA: 3.8/4.0",
    ],
  },
];
...
const experience = [
  {
    ...
    achievements: [
      "Built microservices handling 10K+ requests/sec using Go and gRPC",
  ...
  },
  {
    ...
    duration: "2022 – 2023",
    achievements: [
      "Developed and shipped 3 major product features end-to-end",
  ...
  },
  {
    ...
    achievements: [
      "Conducting research on transformer architectures for code generation",
      "Published findings at a peer-reviewed conference",
      "Built evaluation benchmarks for model performance",
    ],
            ...
            >
              ...
              <div>
                ...
                <ul className="space-y-1">
                  {item.details.map((d) => (
                    <li key={d} className="text-muted-foreground text-sm">• {d}</li>
                  ))}
                </ul>
              </div>
            </motion.div>
                    ...
                    <div className="flex-1">
                      ...
                      <ul className="space-y-1 mb-4">
                        {item.achievements.map((a) => (
                          <li key={a} className="text-muted-foreground text-sm">• {a}</li>
                        ))}
                      </ul>
